      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[#0a0a0a]">
        ...
        <div className="h-14 bg-black/80 backdrop-blur-sm border-b border-white/5 flex items-center justify-between px-4 z-10">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="h-4 w-[1px] bg-border mx-1"></div>
            <ThemeSwitcher />
            <button className="p-2 text-secondary hover:text-primary rounded"><Settings size={16} /></button>
          </div>
        </div>
            ...
            <div className="flex-1 h-full relative">
              {loading ? (
                ...
                <Editor
                  ...
                  options={{ minimap: { enabled: false }, fontSize: 14, fontFamily: '"Fira Code", monospace', padding: { top: 16 }, smoothScrolling: true }}
                />
              ) : (
